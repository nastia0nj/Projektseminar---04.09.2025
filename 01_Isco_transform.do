/* 
Deriving ISCO-88 classifications from ISCO-08 data. This is the code from Harry Ganzeboom to convert occupations from ISCO-08 to ISCO-88.


Using this transformation specifically to construct the Offshorability Index and to identify globalization winners and losers, as well as modernization winners and losers following the frameworks of Kitschelt and Oesch.
 
*/

*clear all 
*use "/Users/nastianedjai/Desktop/Makrovariables/Kumulierter Datensatz/ESS201418.dta" // Use ESS-Data
...
*replace iscoco=0 if isco08==9999
...
replace iscoco=100 if isco08<1000 & isco08~=.

sum isco08 iscoco if isco08~=. & iscoco==. // did everything work?
